...
type FormProps = {
    ...
    handleChange: (e: ChangeEvent<HTMLInputElement> | ChangeEvent<HTMLTextAreaElement> | ChangeEvent<HTMLSelectElement>) => void
    handleSubmit: (e: FormEvent<HTMLFormElement>) => void
    isValidAlgorithms: () => boolean
}

export default function Form({ algorithms, handleSubmit, handleChange, isValidAlgorithms }: FormProps) {
