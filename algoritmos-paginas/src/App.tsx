  ...
  return (
    <>
      ...
      <main>
              ...
              <div className="cont__camp">
                ...
                <div className="camp__inputs">
                  ...
                  <div className="camp">
                    ...
                    <input className="camp__txt" type="number" name="number_pages" id="number_pages" placeholder='Ej: 7' />
                  </div>

                  <div className="camp">
                    <label htmlFor="number_frames">Números de marcos de la RAM</label>
                    <input className="camp__txt" type="number" name="number_frames" id="number_frames" placeholder='Ej: 3' />
                  </div>
        ...
        <div id="algoritms_id" className="algoritms__background algoritms__show">
          <div className="algoritms__content">
            <section className="algoritms background__camp">
              {
                /**
